System.register(['./_virtual_cc-CZmAR8L0.js'], (function (exports) {
  'use strict';
      ...
      var spineWasm = exports("default", function () {
        ...
        return function (spineWasm) {
          ...
          var Q = undefined,
            R = {};
          function Sa(a, b) {
            for (undefined === b && L("ptr should not be undefined"); a.M;) b = a.Z(b), a = a.M;
            return R[b];
          }
          function Ta(a, b) {
          ...
          function Va(a, b) {
            f.hasOwnProperty(a) ? (L("Cannot register public name '" + a + "' twice"), Ua(f, a, a), f.hasOwnProperty(undefined) && L("Cannot register multiple overloads of a function with the same number of arguments (undefined)!"), f[a].N[undefined] = b) : f[a] = b;
          }
          ...
          function $a(a, b) {
            ...
            if (this.ba) switch (undefined === b.I.O && L("Passing raw pointer to smart pointer is illegal"), this.sa) {
              case 0:
          ...
          function V(a, b, c, d) {
            ...
            this.aa = d;
            this.ba = false;
            this.V = this.qa = this.pa = this.ga = this.sa = this.na = undefined;
            undefined !== b.M ? this.toWireType = $a : (this.toWireType = d ? Ya : ab, this.S = null);
          }
          function cb(a, b) {
          ...
          function jb(a, b, c, d, e) {
            ...
            var k = null !== b[1] && null !== c,
              g = false;
            for (c = 1; c < b.length; ++c) if (null !== b[c] && undefined === b[c].S) {
              g = true;
              break;
            }
            var l = "void" !== b[0].name,
          ...
          var qb = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : undefined;
          function Aa(a, b, c) {
            var d = b + c;
            for (c = b; a[c] && !(c >= d);) ++c;
          ...
          function rb(a, b) {
            var c = J[a];
            undefined === c && L(b + " has unknown type " + fb(a));
            return c;
          }
          var sb = {},
            tb = [],
          ...
          T.prototype["delete"] = function () {
            ...
            Na(this);
            Oa(this.I);
            this.I.Y || (this.I.O = undefined, this.I.K = undefined);
          };
          ...
          f.count_emval_handles = function () {
            for (var a = 0, b = Z.ea; b < Z.R.length; ++b) undefined !== Z.R[b] && ++a;
            return a;
          };
          var Ab = {
            z: function z() {
            ...
            c: function c(a, b, _c, d, e, h, k, g, l, n, m, q, r) {
              ...
              N([a, b, _c], d ? [d] : [], function (t) {
                ...
                t = Ha(u, function () {
                  ...
                  if (undefined === y.U) throw new K(m + " has no accessible constructor");
                  var ib = y.U[arguments.length];
                  if (undefined === ib) throw new K("Tried to invoke ctor of " + m + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(y.U).toString() + ") parameters instead!");
                ...
                y.M && (undefined === y.M.$ && (y.M.$ = []), y.M.$.push(y));
            ...
            g: function g(a, b, c, d, e, h, k) {
              ...
              N([], [a], function (l) {
                ...
                undefined === q[b] ? (n.W = c - 1, q[b] = n) : (Ua(q, b, m), q[b].N[c - 1] = n);
                N([], g, function (r) {
                  r = jb(m, [r[0], null].concat(r.slice(1)), null, h, k);
                  undefined === q[b].N ? (r.W = c - 1, q[b] = r) : q[b].N[c - 1] = r;
                  if (l.J.$) {
            ...
            d: function d(a, b, c, _d, e, h) {
              ...
              N([], [a], function (g) {
                ...
                undefined === g.J.U && (g.J.U = []);
                if (undefined !== g.J.U[b - 1]) throw new K("Cannot register multiple constructors with identical number of parameters (" + (b - 1) + ") for class '" + g.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
                g.J.U[b - 1] = function () {
            ...
            a: function a(_a, b, c, d, e, h, k, g) {
              ...
              N([], [_a], function (n) {
                ...
                var r = n.J.T,
                  u = r[b];
                undefined === u || undefined === u.N && u.className !== n.name && u.W === c - 2 ? (m.W = c - 2, m.className = n.name, r[b] = m) : (Ua(r, b, q), r[b].N[c - 2] = m);
                N([], l, function (t) {
                  t = jb(q, t, n, h, k);
                  undefined === r[b].N ? (t.W = c - 2, r[b] = t) : r[b].N[c - 2] = t;
                  return [];
                });
                return [];
              });
